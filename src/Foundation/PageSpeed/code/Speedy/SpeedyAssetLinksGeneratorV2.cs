...
{
    public class SpeedyAssetLinksGeneratorV2 : AssetLinksGenerator
    {
        private readonly AssetConfiguration _configuration;

        public SpeedyAssetLinksGeneratorV2() : base()
        {
            _configuration = AssetConfigurationReader.Read();
        }

        public new void AddUrlIncludeSpeedy(UrlInclude urlInclude, AssetLinks result)
        {
        ...
        public static SpeedyAssetLinks GenerateDeferedLinks(IThemesProvider themesProvider)
        {
            ...
            var assetsGenerator = new SpeedyAssetLinksGeneratorV2();
